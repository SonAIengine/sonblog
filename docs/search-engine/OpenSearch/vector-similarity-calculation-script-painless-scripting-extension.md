...
description: "OpenSearch의 k-NN Painless Scripting Extension을 정리한다. knn_vector 필드에 대해 L2, cosine similarity, L1 등의 거리 함수를 Painless 스크립트에서 직접 호출하여 커스텀 스코어링을 구현하는 방법을 다룬다."
date: 2025-07-11
tags:
  - OpenSearch
  - 검색엔진
