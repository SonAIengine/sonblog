...
description: "대규모 언어 모델의 효율적인 서빙을 위해 vLLM과 llama.cpp 기반 추론 엔진을 구축한 과정. GPU 리소스 최적화, 동적 배칭, CUDA 메모리 관리까지 프로덕션 경험을 정리한다."
date: 2025-12-01
series: "XGEN 개발기"
series_order: 2
difficulty: advanced
...
- [Admin 모델 서빙 매니저: GPU 현황과 모델 배포 UI](../../full-stack/frontend/Admin-모델-서빙-매니저-GPU-현황과-모델-배포-UI.md): XGEN 2.0에서 다중 백엔드(vLLM/llamacpp/sglang) 지원, GPU 자동 감지, HuggingFace 검색까지 통합한 모델 관리 UI