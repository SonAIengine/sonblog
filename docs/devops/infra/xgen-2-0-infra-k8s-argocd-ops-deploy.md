...
description: "K3s 기반 Kubernetes 클러스터에 ArgoCD, Istio, Grafana, Prometheus를 구성하여 AI 플랫폼 6개 마이크로서비스를 GitOps 방식으로 운영 배포한 과정."
date: 2026-01-10
series: "DevOps 실전"
series_order: 2
difficulty: advanced
tags:
  ...
  - 쿠버네티스
depends_on:
  - devops/infra/search-api-llmops-docker-compose.md
related:
  ...
  - devops/infra/argocd-multi-client-site-deploy-architecture-applicationset-trial-error-single-entry-point-design.md
---
