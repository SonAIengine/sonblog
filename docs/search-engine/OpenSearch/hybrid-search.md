...
description: "OpenSearch 2.11의 Hybrid Search 기능을 정리한다. Search Pipeline을 통해 키워드 검색(BM25)과 Neural Search 결과를 결합하고 normalization/combination processor로 점수를 조정하는 방법을 다룬다."
date: 2025-07-11
tags:
  - OpenSearch
  - 검색엔진
