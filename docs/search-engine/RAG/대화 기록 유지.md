---
title: "대화 기록 유지"
description: "챗봇이 사용자의 질문을 기억하고 맥락에 맞게 답변하면 대화 경험이 자연스러워진다. 반대로 이전 메시지를 고려하지 못하면 질문-답변이 단절되어 사용자는 불편함을 느낀다. 따라서 대화 이력을 효과적으로 관리하는 메모리 계층은 실용적인 챗봇 개발에서 필수 요소이다."
date: 2025-07-20
tags:
  - 검색엔진
  - RAG
