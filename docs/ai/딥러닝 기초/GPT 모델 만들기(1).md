---
title: "GPT 모델 만들기 (1) - 데이터 전처리와 기본 모델 구조"
description: "data 딕셔너리의 train 키에서 document 값을 가져와 모든 문서를 하나의 문자열로 합친다. 이렇게 만들어진 전체 텍스트에서 중복을 제거하고 정렬된 고유한 문자 목록을 생성한다."
date: 2025-07-05
tags:
  - AI
  - GPT
