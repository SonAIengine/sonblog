---
title: "OpenSearch Embedding 모델 등록 및 활용"
description: "OpenSearch에서 OpenAI API를 사용해 임베딩 모델을 등록하고 자동 임베딩 생성 파이프라인을 구성하는 방법을 정리한다. ML Commons connector 설정부터 text_embedding processor 적용까지 다룬다."
date: 2025-06-29
tags:
  - OpenSearch
  - 검색엔진
